...
frappe.provide("frappe.templates");'use strict';
...
$(document).ready(function () {
	...
	if (getCookie("system_user") === "yes" && logged_in) {
		$("#website-post-login .dropdown-menu").append('<li><a href="/desk">' + __('Switch To Desk') + '</a></li>');
		$(".navbar-header .dropdown:not(.dropdown-submenu) > .dropdown-menu").append('<li><a href="/desk">' + __('Switch To Desk') + '</a></li>');
	}
